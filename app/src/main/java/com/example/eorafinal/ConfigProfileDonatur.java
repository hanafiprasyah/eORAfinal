...
class ConfigProfileDonatur {
    ...
    public static final String KEY_USERNAME            = "username_login";
    public static final String KEY_NAMA                = "nama_donatur";
    public static final String KEY_EMAIL               = "email_donatur";
    public static final String KEY_NOTEL               = "notel_donatur";
